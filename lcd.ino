...
void goal(int p){
  //Code below prints and creates blinking effect for the message
   for(int i=0;i<3;i++){
      lcd.setCursor(0,0); // Set location of line (0) to print message 
      lcd.print("PLAYER "+String(p)+" SCORES!"); // Print on line 0 
      delay(300);
      lcd.setCursor(0,0);
      lcd.print("                ");
   }
